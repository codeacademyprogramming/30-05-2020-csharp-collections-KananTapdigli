...
namespace CollectionsTask
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var result_2 = debtors.FindAll(d => d.Email.Contains("@rhyta.com") || d.Email.Contains("@dayrep.com"));
            ...
            /*3.*/
            Console.WriteLine("======================================");
            Console.WriteLine("3. Yashi 26-dan 36-ya qeder olan borclular: ");
            var result_3 = debtors.FindAll(d => DateTime.Now.Year - d.BirthDay.Year >= 26 && DateTime.Now.Year - d.BirthDay.Year <= 36);
            ...
            /*4.*/
            Console.WriteLine("======================================");
            Console.WriteLine("4. Borcu 5000-den cox olmayan borclular: ");
            var result_4 = debtors.FindAll(d => d.Debt < 5000);
            ...
            /*5.*/
            Console.WriteLine("======================================");
            Console.WriteLine("5. Butov adi 16 simvoldan cox olan ve telefon nomresinde 2 ve ya 2-den cox 7 reqemi olan borclular: ");
            var result_5 = debtors.FindAll(d => d.FullName.Length > 16 && d.Phone.Count(p => p == '7') >= 2);
            ...
            /*7.*/
            Console.WriteLine("======================================");
            Console.WriteLine("7. Qishda anadan olan borclular: ");
            var result_7 = debtors.FindAll(d => d.BirthDay.Month == 12 || d.BirthDay.Month == 1 || d.BirthDay.Month == 2);
            foreach (var item in result_7)
            {
                Console.WriteLine(item);
            }
            Console.WriteLine("======================================");
            ...
            /*8.*/
            Console.WriteLine("======================================");
            Console.WriteLine("8. Borcu, umumi borclarin orta borcunnan cox olan borclular(familiaya gore siralanmis): ");
            int AllDebts = 0;

            for (int i = 0; i < debtors.Count; i++)
            {
                AllDebts = AllDebts + debtors[i].Debt;
            }

            int averageDebt = AllDebts / debtors.Count;

            var result_8 = debtors.FindAll(d => d.Debt > averageDebt);

            //Familiasina gore sort
            result_8.Sort((x, y) => x.FullName[x.FullName.IndexOf('.') - 1].CompareTo(y.FullName[y.FullName.IndexOf('.') - 1]));
            foreach (var item in result_8)
            {
                Console.WriteLine(item);
            }
            Console.WriteLine("======================================");
            ...
            //Meblegin azalmasina gore sort
            Console.WriteLine("======================================");
            Console.WriteLine("8. Borcu, umumi borclarin orta borcunnan cox olan borclular(meblegin azalmasina gore siralanmis): ");
            result_8.Sort((x, y) => y.Debt.CompareTo(x.Debt));
            foreach (var item in result_8)
            {
                Console.WriteLine(item);
            }
            ...
            /*9.*/
            Console.WriteLine("======================================");
            Console.WriteLine("9. Telefon nomresinde 8 olmayan borclularin yalniz familyasi,yashi ve umumi borc meblegi: ");
            var result_9 = debtors.FindAll(d => d.Phone.Contains('8') == false);
            foreach (var item in result_9)
            {
                Console.WriteLine($"Familyasi: {item.FullName.Substring(item.FullName.IndexOf('.') - 1)}, Yasi: {DateTime.Now.Year - item.BirthDay.Year},  Borcu: {item.Debt}");
            }
            Console.WriteLine("======================================");
            ...
            /*11.*/
            Console.WriteLine("======================================");
            Console.WriteLine("11. Adinda ve familyasinda hec olmasa 3 eyni herf olan borclularin siyahisi(elifba sirasina gore siralanmis) : ");
            List<Debtor> result_11 = new List<Debtor>();


            for (char c = 'a'; c <= 'n'; c++)
            {
                result_11.AddRange(debtors.FindAll(d => d.FullName.Count(l => l == c) >= 3));
            }

            result_11.Sort((x, y) => x.FullName.CompareTo(y.FullName));
            ...
            /*13.*/
            Console.WriteLine("======================================");
            Console.WriteLine("13.  En Cox Borcu Olanin Doguldugu il : ");
            var result_13 = debtors.OrderByDescending(x => x.Debt).Take(1);
            foreach (var item in result_13)
            {
            ...
            /*14.*/
            Console.WriteLine("======================================");
            Console.WriteLine("14. Borcu en boyuk olan 5 borclunun siyahisi : ");
            var result_14 = debtors.OrderByDescending(x => x.Debt).Take(5);

            foreach (var item in result_14)
            {
                Console.WriteLine(item);
            }
            ...
            /*15.*/
            Console.WriteLine("======================================");
            Console.WriteLine("15. Butun borcu olanlarin cemi borcu : ");
            int allDebts = 0;
            var result_15 = debtors.Where(d => d.Debt > 0);
            foreach (var item in result_15)
            {
                allDebts = allDebts + item.Debt;
            }

            Console.WriteLine(allDebts);
            Console.WriteLine("======================================");

            /*16.*/
            Console.WriteLine("======================================");
            Console.WriteLine("16. 2ci dunya muharibesin gormush borclularin siyahisi : ");
            var result_16 = debtors.FindAll(d => d.BirthDay.Year < 1939);
            foreach (var item in result_16)
            {
                Console.WriteLine(item);
            }
            Console.WriteLine("======================================");
            ...
            /*18.*/
            Console.WriteLine("======================================");
            Console.WriteLine("18. Nomresinde tekrar reqemler olmayan borclular ve onlarin borcunun meblegi : ");
            List<Debtor> result_18 = new List<Debtor>();

            bool apply = true;
            foreach (var item in debtors)
            {
                for (int i = 0; i < item.Phone.Length - 1; i++)
                {
                    if (item.Phone[i] != item.Phone[i + 1])
                    {
                        apply = true;
                    }
                    else
            ...
            foreach (var item in result_18)
            {
                Console.WriteLine($"Full Adi: {item.FullName},Nomresi: {item.Phone}, Borcu:{item.Debt}");
            }
            Console.WriteLine("======================================");
            ...
            /*19.*/
            Console.WriteLine("======================================");
            Console.WriteLine("19. Butun borclari olanlar bugunden etibaren her ay 500 azn pul odeyecekler. Oz ad gunune kimi borcun oduyub qurtara bilenlerin siyahisi : ");
            int remainMonth;
            List<Debtor> result_19 = new List<Debtor>();
            ...
            foreach (var item in debtors)
            {
                ...
                {
                    remainMonth = item.BirthDay.Month - DateTime.Now.Month;
                }
                else
                {
                    remainMonth = DateTime.Now.Month - item.BirthDay.Month;
                }

                if (remainMonth * 500 >= item.Debt)
                {
                    result_19.Add(item);
                }
            }

            foreach (var item in result_19)
            {
                Console.WriteLine(item);
            }
            ...
            /*20.*/
            Console.WriteLine("======================================");
            Console.WriteLine("20. Adindaki ve familyasindaki herflerden 'smile' sozunu yaza bileceyimiz borclularin siyahisi : ");
            var result_20 = debtors.FindAll(d => d.FullName.ToLower().Contains('s') && d.FullName.ToLower().Contains('m') && d.FullName.ToLower().Contains('i') && d.FullName.ToLower().Contains('l') && d.FullName.ToLower().Contains('e'));
            foreach (var item in result_20)
            {
                Console.WriteLine(item);
            }
            Console.WriteLine("======================================");
